...
DamMet: deammeth.cc myargparser.cc nlopt-2.5.0/install/include/nlopt.hpp htslib/libhts.a
	g++  -O3  deammeth.cc myargparser.cc ./htslib/libhts.a -std=c++11 -I nlopt-2.5.0/install/include -L nlopt-2.5.0/install/lib  -I./htslib/ -lz -lm -lbz2 -llzma -lnlopt -o DamMet -lpthread
...
nlopt-2.5.0/install/include/nlopt.hpp:
	...
	cd nlopt-2.5.0/ && mkdir -p build/  && cd build/ && cmake -DCMAKE_INSTALL_PREFIX=../install .. && make && make install && cd ../..
