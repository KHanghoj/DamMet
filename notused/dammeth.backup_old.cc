...
// long double mcmc_loglike(const general_settings & settings, const mcmc_meth_mat & d, const std::vector<per_site> & data){
//   long double ll=0;
//   double res=0;
...
void run_mcmc(const general_settings & settings, const tally_mat_freq & tmf, std::vector<per_site> data){
  ...
  ll_old = mcmc_loglike(settings, d_old, data);
  ...
  // d_old[0][10][0] = 0;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0 << '\n';
  // d_old[0][10][0] = 0.1;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.1 << '\n';
  // d_old[0][10][0] = 0.2;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.2 << '\n';
  // d_old[0][10][0] = 0.3;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.3 << '\n';
  // d_old[0][10][0] = 0.4;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.4 << '\n';
  // d_old[0][10][0] = 0.5;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.5 << '\n';
  // d_old[0][10][0] = 0.6;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.6 << '\n';
  // d_old[0][10][0] = 0.7;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.7 << '\n';
  // d_old[0][10][0] = 0.8;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.8 << '\n';
  // d_old[0][10][0] = 0.9;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 0.9 << '\n';
  // d_old[0][10][0] = 1;
  // std::cerr << mcmc_loglike(settings, d_old, data) << " " << 1 << '\n';
